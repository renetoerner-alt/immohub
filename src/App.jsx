    ...
    <div className="mod">
      ...
      <div className="accs">
        <Acc icon={<IconObjekt color="#6366f1" />} title="Objekt" sum={(p.isContainer ? '🏢 Gebäude · ' : '') + (s.name || 'Name eingeben...')} open={sec === 'obj'} toggle={() => setSec(sec === 'obj' ? null : 'obj')} color="#6366f1" onImport={onOpenImport}>
          ...
          {!parentGebaeude && (
            <div style={{display:'inline-flex',gap:'8px',padding:'8px',marginBottom:'12px',background:'rgba(34,197,94,0.05)',border:'1px solid rgba(34,197,94,0.2)',borderRadius:'8px',maxWidth:'520px'}}>
              <label style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'8px 14px',background:(s.besitzstatus||'eigentum')==='eigentum'?'rgba(34,197,94,0.18)':'transparent',border:`1px solid ${(s.besitzstatus||'eigentum')==='eigentum'?'#22c55e':'var(--border)'}`,borderRadius:'6px',cursor:'pointer',whiteSpace:'nowrap'}}>
              ...
              <label style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'8px 14px',background:s.besitzstatus==='interesse'?'rgba(245,158,11,0.18)':'transparent',border:`1px solid ${s.besitzstatus==='interesse'?'#f59e0b':'var(--border)'}`,borderRadius:'6px',cursor:'pointer',whiteSpace:'nowrap'}}>
                ...
                <span style={{display:'inline-flex',alignItems:'center',width:'22px',height:'22px'}}><IconSearch color="#f59e0b" /></span>
          ...
          {parentGebaeude ? (
            ...
            <div className="container-toggle" style={{display:'inline-flex',gap:'8px',padding:'10px',marginBottom:'12px',background:'rgba(99,102,241,0.05)',border:'1px solid rgba(99,102,241,0.2)',borderRadius:'8px',maxWidth:'520px'}}>
              <label style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'8px 14px',background:!p.isContainer?'rgba(99,102,241,0.15)':'transparent',border:`1px solid ${!p.isContainer?'#6366f1':'var(--border)'}`,borderRadius:'6px',cursor:'pointer',whiteSpace:'nowrap'}}>
              ...
              <label style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'8px 14px',background:p.isContainer?'rgba(99,102,241,0.15)':'transparent',border:`1px solid ${p.isContainer?'#6366f1':'var(--border)'}`,borderRadius:'6px',cursor:'pointer',whiteSpace:'nowrap'}}>
                ...
                <span style={{display:'inline-flex',alignItems:'center',width:'22px',height:'22px'}}><IconObjekt color="#6366f1" /></span><span style={{fontSize:'13px',fontWeight:p.isContainer?'600':'400'}}>Gebäude mit Einheiten</span>
              </label>
            </div>
          )}
          {p.isContainer && (
